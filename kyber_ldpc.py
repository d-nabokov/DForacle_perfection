...
from src.cmd_utils import get_config

cfg = get_config(sys.argv[1:])
if not cfg.simulate_oracle:
    # keeping only 1 thread in Python to reduce noise from it, i.e.
    # we don't want these threads to work while the main one is sleeping
    # waiting for the response from the oracle
    for v in (
        "OMP_NUM_THREADS",
...
if platform.system() == "Darwin" and (
    ...
    print("Setting QOS class to user-interactive")
